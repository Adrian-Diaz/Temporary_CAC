...
FixStyle(CAC/setdof,FixCAC_Set_DOF)

#else

#ifndef LMP_FIX_CAC_SETDOF_H
#define LMP_FIX_CAC_SETDOF_H

#include "fix.h"

namespace LAMMPS_NS {

class FixCAC_Set_DOF : public Fix {
 public:
	 FixCAC_Set_DOF(class LAMMPS *, int, char **);
  virtual ~FixCAC_Set_DOF();
  int setmask();
  virtual void init();
  void setup(int);
  void min_setup(int);
