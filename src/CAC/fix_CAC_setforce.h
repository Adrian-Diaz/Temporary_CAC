...
#ifndef LMP_FIX_CAC_SETFORCE_H
#define LMP_FIX_CAC_SETFORCE_H

#include "fix.h"

namespace LAMMPS_NS {

class FixCAC_Set_Force : public Fix {
 public:
	 FixCAC_Set_Force(class LAMMPS *, int, char **);
  virtual ~FixCAC_Set_Force();
  int setmask();
  virtual void init();
  void setup(int);
  void min_setup(int);
